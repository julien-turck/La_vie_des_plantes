	...
	class PageTemplatesDirectory {
		...
		public function templates_list() {
			...
			'ad-agency-lite-elementor'              => array(
					...
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/digital-ad-agency-wordpress-theme/'),						
					'demo_url'    => esc_url('https://demosktthemes.com/free/ad-agency-lite/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/ad-agency-lite/ad-agency-lite.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/ad-agency-lite/ad-agency-lite.json'),
					'keywords'    => __( ' agency, agency elementor, agency wordpress, Best Agency theme, creative agency theme, creative portfolio, design agency, design studio, digital marketing agency, personal portfolio, portfolio showcase, rtl support, smooth scrolling, startup agency, web design agency, ads, ads agency, advertisement, advertising, adwords, bing ads, facebook ads, google ads, google advertising, instagram ads, linkedIn ads, outdoor advertising, ppc, tiktok ads, youtube ads, ad agency lite, Ad Agency Lite'),
			),			
			'garden-care-lite-elementor'              => array(
					'title'       => __( 'Garden Care Lite', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/garden-landscaper-wordpress-theme/'),						
					'demo_url'    => esc_url('https://demosktthemes.com/free/garden-care-lite/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/garden-care-lite/garden-care-lite.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/garden-care-lite/garden-care-lite.json'),
					'keywords'    => __( ' gardencare, garden, landscape, grass cutting, groundskeeping, horticulture, lawn care, custodianship, guardianship, oversight, stewardship, turf management, yard maintenance, work, supervision, garden care, Garden Care'),
			),			
			'nail-salon-lite-elementor'              => array(
					'title'       => __( 'Nail Salon Lite', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/nail-salon-wordpress-theme/'),						
					'demo_url'    => esc_url('https://demosktthemes.com/free/nail-salon-lite/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/nail-salon-lite/nail-salon-lite.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/nail-salon-lite/nail-salon-lite.json'),
					'keywords'    => __( ' salon, Nail Salon, beauty, beauty center, beauty salon, beauty spa, beauty treatment, booking, elementor, nail salon, resort, skincare, spa, spa center, wellness, wellness center, yoga barber salon, business, hair, makeup, manicure, massage wordpress, nail art, nail bar, nail design, pedicure, woocommerce'),
				),
				...
				'skt-nutritionist-coach-elementor'              => array(
					...
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/nutritionist-coach-wordpress-theme'),						
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-nutritionist-coach/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-nutritionist-coach/skt-nutritionist-coach.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-nutritionist-coach/skt-nutritionist-coach.json'),
					'keywords'    => __( ' fitness instructor, gym, health and beauty, health coach, healthy lifestyle, life coach, organic shop & store, personal coach, personal mentor, personal trainer, training, wellness, yoga, nutritionist coach, nutritionistcoach, Nutritionist Coach, NutritionistCoach' ),
				),			
				'skt-barbecue-elementor'              => array(
					'title'       => __( 'SKT Barbecue', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/free-spice-wordpress-theme'),						
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-barbecue/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-barbecue/skt-barbecue.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-barbecue/skt-barbecue.json'),
					'keywords'    => __( ' cafe, food, food menu, kitchen, pub, restaurant, barbecue, burger, caffe, cooking, diner, fast food, grill, hotel, meal, pizza, pizzeria, restaurant bistro, sushi, bar, catering, coffee, dining, food delivery, jerky, Mexican Food, organic, taco, italian restaurant, seafood, table booking, pastry, Barbecue, bbq, barbeque' ),
				),			
				'skt-gardening-lite-elementor'              => array(
					'title'       => __( 'Gardening', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/free-gardening-wordpress-theme/'),						
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-gardening/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-gardening/skt-gardening.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-gardening/skt-gardening.json'),
					'keywords'    => __( ' park, yard, orchard, lawn, gardening, field, kitchen garden, backyard, farm, flowerbed, patch, vegetable garden, bed, cultivate, parkland, flowery, back garden, gardens, kindergarten, plot, yard guy, landscaper, estate, outfielder, gardener, green, groundskeeper, sadik, back yard, playground, grounds, landscaped, paradise, court, arboretum, flower bed, hothouse, patio, horticultural, plant, in the backyard, conservatory, oasis, victory garden, grove, household, flower garden, greenskeeper, herb garden, nursery, in the yard, stock, into the garden, in the garden, produce crops, groundsman, fleet, estates, terrace, garden-variety, potager, jardin, courtyard, border, fruit farm, parc, yard work, parque, in the back yard, verger, greenhouse, arena, vegetable, landscaping, market garden, plantation, enclosure, terrasse, courtyard area, paradiso, heavenly, heaven, yardman, grassland, just like heaven, paradises, horticulture, vegetable patch, horticulturally, bowerbird, parks, yardmaster, side yard, garden plot, allotment, madison, property, sadiq, gardened, garden spot, gardening, Gardening' ),
				),
				...
				'solar-energy-elementor'              => array(
					'title'       => __( 'Solar Energy', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/free-clean-energy-wordpress-theme/'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/solar-energy/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/solar-energy/solar-energy.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/solar-energy/solar-energy.json'),
					'keywords'    => __( ' products, distributor, market products, 3rd party provided services, solar products, invention, informational products, financial products, solar business, solar panel setup, solar power, smart inventory, solar pv, solar thermal systems, solar attic fans, solar cooling systems, solar insurance products, solar cleaning, solar financing, solar for rv vehicles, solar products for boats, solar products for recreational users, solar powered agricultural buildings, government, mobile apps for people interested in solar energy, producing research reports, e-books, instructional videos, solar training classes, install solar, mortgage brokers, solar brokerage service, solar appraisal business, new inverters, wiring replaced, storm damage repairs, solar heaters installations, non-profit solar business, promote solar energy awareness, solarenergy, solar energy, Solar Energy', 'skt-templates' ),
				),
				'adventure-lite-elementor'              => array(
					'title'       => __( 'Adventure Lite', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('https://www.sktthemes.org/shop/free-travel-blog-wordpress-theme/'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/adventure-lite/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/adventure-lite/adventure-lite.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/adventure-lite/adventure-lite.json'),
					'keywords'    => __( ' traveling, trek, happy movement, expedition, cruise, backpack, visit, trips, tour, vacationing, voyage, roaming, action, go, roll, move, journey, safari, touring, journey, trip, go abroad, peregrinate, riding, journey, motion, movement, change, taking a trip, stay, holidaying, spring break, vacation, furlough, summer vacation, vacancies, vacation time, tour, travel, vacay, breaks, offseason, vacationing, resort, summer vacation, breakdown, weekends, recesses, rests, package, outings, staying, summer holiday, summer break, summer recess, major holidays, high holidays, big holiday, great holiday, long vacations, break, summering, long vacation, summer recreation, holiday, summer activities, summer enjoyment, summer entertainment, summer fun, summer gaiety, summer joviality, summer joy, summer merriment, summer pleasure, summer relax, summer relaxation, summer rest, summertime, entertainment, summertime fun, summertime joy, summertime pleasure, holiday period, summer leisure activities, summer camps, great festivals, large parties, summertime, major festivals, major feasts, spend the summer, festivals, main festivals, spring, midsummer, estate, adventure, Adventure', 'skt-templates' ),
				),
